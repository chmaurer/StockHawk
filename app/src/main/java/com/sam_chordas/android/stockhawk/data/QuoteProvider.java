...
public class QuoteProvider {
  ...
  private static Uri buildUri(String... paths){
    ...
    private static final String sStockQuoteSymbolSelection = QuoteDatabase.QUOTES +
            "." + QuoteColumns.SYMBOL + " = ? ";
/*
    private Cursor getQuotesForSymbol (
            Uri uri, String[] projection, String sortOrder) {

        String symbol = uri.getPathSegments ().get (1);
        String[] selectionArgs  =new String[]{symbol};
        String selection = sStockQuoteSymbolSelection;
